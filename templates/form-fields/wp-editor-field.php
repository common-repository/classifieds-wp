...
<span class="wp_editor_wrapper <?php echo ( ! isset( $field['name'] ) ? 'wp_editor_empty' : '' ); ?>"></span>

<?php
$editor = apply_filters( 'submit_classified_form_wp_editor_args', array(
	'textarea_name' => isset( $field['name'] ) ? $field['name'] : $key,
	'media_buttons' => false,
	'textarea_rows' => 8,
	'quicktags'     => false,
	'editor_class'  => $field['required'] ? 'required' : '',
	'tinymce'       => array(
